...
After setting up the repository, head to [getting started](Archive/getting-started.md) to get familiar with your new knowledge base!
...
- [inbox](Archive/inbox.md) - a place to write down quick notes to be categorized later
- [getting-started](Archive/getting-started.md) - learn how to use your Foam workspace
